...
ref_menu = 'contacts.menu_contacts'
group_id_new = 'bt_menu_special_contacts.group_bt_menu_special_contacts'
groups_ids = ['base.group_partner_manager','base.group_user']
